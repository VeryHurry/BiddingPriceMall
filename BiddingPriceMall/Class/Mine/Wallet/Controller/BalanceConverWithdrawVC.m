...
#import "BalanceConverWithdrawVC.h"

@interface BalanceConverWithdrawVC ()
...
@implementation BalanceConverWithdrawVC

- (void)viewDidLoad {
    [super viewDidLoad];
    self.view.backgroundColor = kBgGray;
    self.nav.title = @"可用转可提";
...
-(void)converBalance
{
    NSDictionary *dic = @{@"id":[kUserDefaults objectForKey:def_id],@"enableBalance":_conver.text};
    [[XXNetWorkMangerBase sharedNetWorkManger] postWithUrl:api_balanceConverWithdraw andData:dic andSuccessBlock:^(id success) {
