...
#define HomeColorStr "0E8BEC"
#define HomeColor ColorWithHex(0x0E8BEC)
#define Home_Text_Color ColorWithHex(0x0E8BEC)
...
//字体灰色
#define kGray ColorWithHex(0x333333)
//字体中灰色
#define kMidGray ColorWithHex(0x666666)
//字体浅灰色
#define kLightGray ColorWithHex(0xc9c9c9)
//背景灰色
#define kBgGray ColorWithHex(0xF0F0F0)
//按钮灰色
#define kBtnGray ColorWithHex(0xF9F9F9)
//线条颜色
#define kLineColor ColorWithHex(0xD2D2D2)
//红色
#define kRed ColorWithHex(0xFE022C)
//蓝色
